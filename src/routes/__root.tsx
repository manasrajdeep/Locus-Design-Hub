...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      // Search Console token for the locusdesign.online property. Tied to that
      // exact origin — a token from another property verifies nothing here, which
      // is what happened with the one carried over from the previous domain.
      { name: "google-site-verification", content: "pVYUvMfzazsLcdzO7-3GFSEHE4FZ4zPCRwt-WV2KSaU" },
